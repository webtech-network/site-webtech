...
const cardData = [
  ...
  },
  {
    ...
    fullDescription:
      "<p class='mb-4 text-justify'>Durante o programa, os participantes contam com acompanhamento constante e suporte especializado para garantir seu desenvolvimento técnico. Essa etapa é fundamental para consolidar os conhecimentos adquiridos e preparar os alunos para os desafios do mercado.</p><p class='mb-4 text-justify'>Para isso, utilizamos o <strong>WebTech Grader</strong>, uma ferramenta desenvolvida para realizar a correção automática das atividades. Além de validar se os requisitos foram corretamente atendidos, a plataforma oferece feedbacks detalhados sobre os pontos que podem ser aprimorados, tanto em relação à qualidade do código quanto à aplicação de boas práticas.</p><p class='mb-4 text-justify'>O <strong>WebTech Grader</strong> também disponibiliza orientações, recursos e sugestões de melhorias, proporcionando uma experiência de aprendizado mais eficiente, dinâmica e alinhada às demandas do mercado de tecnologia.</p><p class='text-justify'>Dessa forma, os alunos conseguem acompanhar sua própria evolução, identificar pontos de melhoria de forma rápida e precisa, além de contar com o suporte contínuo de profissionais que atuam diretamente na área.</p>",
  },
];
...
const partners = [
  {
    ...
    descricao:
      "A NetProject oferece serviços e soluções integradas para práticas híbridas de Gestão de Projetos para o que importa de verdade: boas decisões e resultados.",
  },
  {
    titulo: "Levty",
    imagem: "/home/partners/levty.png",
    descricao:
      "Times de profissionais qualificados em plataforma digital corporativa que trabalham de forma dedicada como parte da sua organização.",
  },
];
  ...
  return (
    <>
      ...
      <section className="container mb-10">
        ...
        <SectionDescription>
          O WebTech Journey é um programa que tem como objetivo promover
          inclusão digital e oportunidades de trabalho para o público geral por
          meio de uma jornada de aprendizado com uma metodologia própria.
          Através da extensão na universidade, o projeto capta alunos e
          professores que fornecem conteúdo e apoio técnico, promovendo uma
          série de eventos de engajamento e multiplicação do conhecimento,
          mostrando todas estas ações em canais de redes sociais (Linkedin,
          Youtube, Instagram e GitHub).
        </SectionDescription>
      </section>

      <section className="container mb-10">
        <h2 className="text-2xl font-semibold mt-10 mb-7">
          Pilares do programa
        </h2>
        <SectionDescription>
          O Journey foi concebido com alguns pilares que norteiam todo o
          processo para capacitação dos participantes, garantindo que eles
          adquiram habilidades técnicas e comportamentais essenciais para o
        ...
        <SectionDescription>
          Na medida em que avança nas etapas, os participantes podem ir
          conquistando bônus na disciplina e também reconhecimento que podem
          compartilhar com seus colegas. A imagem a seguir sintetiza essa
          dinâmica.
          <img
            src="/icons/journey-estrutura.png"
            className="w-400 h-auto md:w-50"
          />
        </SectionDescription>
      </section>
      ...
      {/*<section className="container mb-10">
        ...
        <div className="text-xl mb-10">
          <h2 className="text-2xl font-semibold mt-10 mb-7">
            Jornada do Projeto Web
          </h2>
          <SectionDescription>
            Bem-vindo à Jornada do Projeto Web, uma oportunidade única de
            aprendizado, onde você apende a desenvolver um site completo ao
            mesmo tempo que descobrirá como suas habilidades técnicas podem
            transformar necessidades reais em soluções impactantes. Ao longo das
            etapas, você será guiado por um processo prático que combina teoria
            e prática, desafia a criatividade e estimula o pensamento crítico.
          </SectionDescription>

          <SectionDescription>
            As tecnologias empregadas na Jornada do Projeto Web são:
          </SectionDescription>
          ...
          <SectionDescription>
            A jornada está dividida em etapas que vão aumentando a complexidade
            na construção de uma aplicação completa e com tecnologias utilizadas
            no mercado.
          </SectionDescription>
          ...
          <div className="mx-auto m-10 p-8 bg-gray">
            <details className="mt-2">
              <summary className="font-semibold">
                Etapa 1 - Site Estático (HTML e CSS)
              </summary>
            ...
            <details className="mt-4">
              <summary className="font-semibold">
                Etapa 2 - Adição de Interatividade (JavaScript)
              </summary>
              <div className="mt-2 ml-4 p-4 border-b-4  border-amber-400 bg-neutral-300">
                <p>
                  São adicionados elementos interativos ao site estático, como
                  botões que mostram ou escondem conteúdo, validação de
                  formulários simples no lado do cliente, ou uma galeria de
                  imagens com funcionalidade de navegação.
                </p>
              </div>
            </details>
            ...
            <details className="mt-4">
              <summary className="font-semibold">
                Etapa 3 - Desenvolvimento de um Back-End Simples (JSONServer)
              </summary>
              <div className="mt-2 ml-4 p-4 border-b-4  border-amber-400 bg-neutral-300">
                <p>
                  O projeto deve integrar um servidor simples baseado no
                  JSONServer, com dados mantidos em um arquivo JSON e que
                  responde a requisições feitas pelo front-end para mostrar
                  dados dinâmicos. Pode incluir funcionalidades como processar
                  formulários e enviar dados de volta ao usuário.
                </p>
              </div>
            </details>
            ...
            <details className="mt-4">
              <summary className="font-semibold">
                Etapa 4 - Integração com Banco de Dados (Node.js e SQL)
              </summary>
              <div className="mt-2 ml-4 p-4 border-b-4  border-amber-400 bg-neutral-300">
                <p>
                  É criado um back end baseado em APIs RESTful, integrado a um
                  banco de dados PostgreSQL que permite o armazenamento de
                  informações de usuários e dados da aplicação, fornecendo
                  funcionalidades de login e telas de administração dos dados do
                  site.
                </p>
              </div>
            </details>
            ...
            <details className="mt-4">
              <summary className="font-semibold">
                Etapa 5 - Refinamento e Implementação de Funcionalidades
                Avançadas
              </summary>
              <div className="mt-2 ml-4 p-4 border-b-4  border-amber-400 bg-neutral-300">
                <p>
                  Os alunos devem adicionar funcionalidades mais complexas, como
                  autenticação de usuários (login/logout), integração com APIs
                  externas (como Google Maps ou APIs de redes sociais), e
                  refinamento do design e usabilidade do site.
                </p>
              </div>
            </details>
            ...
            <details className="mt-4">
              <summary className="font-semibold">
                Etapa Final - Avaliação e Classificação do Projeto Web
              </summary>
              <div className="mt-2 ml-4 p-4 border-b-4  border-amber-400 bg-neutral-300">
                <p className="mb-4">
                  Uma vez o projeto entregue por meio de um repositório público
                  do GitHub, registrando sua participação no programa, será
                  feita uma avaliação do site e o projeto pode ser enquadrado em
                  3 classes:
                </p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Nível 1 - Master:</strong> projeto que atende a um
                    cliente real, contendo funcionalidades de dados dinâmicos
                    armazenados em bancos de dados e ambiente administrador com
                    segurança, publicado na Internet em domínio específico
                    (siteX.com.br) e com visibilidade registrada no Google Meu
                    Negócio.
                  </li>
                  <li>
                    <strong>Nível 2 - Intermediário:</strong> projeto fictício
                    ou com cliente real, apresentando funcionalidades com dados
                    dinâmicos armazenados em bancos de dados.
                  </li>
                  <li>
                    <strong>Nível 3 - Simples:</strong> Projeto fictício
                    entregue por meio de arquivo zip ou publicado em servidores
                    gratuitos.
                  </li>
                </ul>
              </div>
          ...
          <div className="place-items-center mx-auto bg-gray relative w-full overflow-hidden aspect-square">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSeectoeclTayxMa6PHaSleM1ybMucC_BbbSg_czeJx07R5LXA/viewform?embedded=true"
      ...
      <section className="bg-primary">
        <div className="container mx-auto py-16">
          ...
          <p className="text-xl my-8">
            As empresas parceiras participam da estruturação do programa,
            contribuindo com conteúdos e ações de engajamento, mas
            principalmente recebendo os participantes para rodadas de
