        ...
        <div className="container mx-auto">
            <div className="md:pt-0  pt-0 m-auto text-secondary-dark">
                <div className="">
                    ...
                    <div className="grid md:grid-cols-1 grid-cols-2 gap-5 pb-[74px]">
                        <a href="https://www.netproject.com.br/" target="blank"><img className="w-[200px] h-[100px] object-cover rounded-xl mx-auto mt-5 drop-shadow-md" src="/home/partners/netproject.png" alt="placeholder" /></a>
                    </div>
