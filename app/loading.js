...
export default function Loading() {
    return (
        <div className="flex items-center   flex-col justify-center h-screen gap-6 bg">
            <div className="border-t-4 border-solid rounded-full border-primaria border-opacity-75 h-28 w-28 animate-spin "></div>



            <div className="loading-text text-3xl font-bold text-secundariaDark">
